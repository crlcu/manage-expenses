...
<?=$this->Form->create('Receivable', array('class' => 'well clearfix'));?>
    <div class="first span4">
		<?=$this->Form->input('date', array('escape' => false, 'label' => array('text' => __('Date'), 'class' => 'span4'), 'type' => 'text', 'class' => 'span8', 'value' => date('Y-m-d'), 'rel' => 'datepicker'));?>
